...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var StringContentManager = function () {
    function StringContentManager() {
      _classCallCheck(this, StringContentManager);
    }

    _createClass(StringContentManager, null, [{
      key: 'normalChar',
      value: function normalChar(charParam) {
        var c = charParam.toLowerCase();
        var allowedChars = "abcdefghijklmnopqrstuvwxyz0123456789";
        return allowedChars.indexOf(c) !== -1;
      }
    }, {
      key: 'normalString',
      value: function normalString(stringParam) {
        var s = stringParam;
    ...
    return StringContentManager;
  }();
  /* harmony export (immutable) */

  __webpack_exports__["a"] = StringContentManager;
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var AjaxWorker = function () {
    function AjaxWorker() {
      _classCallCheck(this, AjaxWorker);
    }

    _createClass(AjaxWorker, null, [{
      key: 'getBasicUrl',
      value: function getBasicUrl() {
        return "http://localhost:5005/";
      }
    }, {
      key: 'sendPost',
      value: function sendPost(url, body, callback) {
        ...
        xhr.onreadystatechange = function () {
          if (xhr.readyState === 4 && xhr.status === 200) {
            var answer = xhr.responseText.toString();
            callback(answer);
            xhr = null;
          }
        };
  ...
  __webpack_exports__["a"] = AjaxWorker;
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Start = function () {
    ...
    _createClass(Start, [{
      ...
      key: 'createAndInitRouter',
      value: function createAndInitRouter() {
      ...
      key: 'createAndInitElementsBase',
      value: function createAndInitElementsBase() {
      ...
      value: function addEventsToElements() {
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  "use strict";
  /* harmony import */
  var __WEBPACK_IMPORTED_MODULE_0__log_in_page_pug__ = __webpack_require__(7);
  ...
  var LogInPage = function () {
    ...
    _createClass(LogInPage, null, [{
      ...
      key: 'addEventsToElements',
      value: function addEventsToElements(router, elementsBase) {
        document.querySelector(".log-in-page__link-to-sign-up-page").addEventListener("click", function () {
          router.moveToPage("/sign-up");
        });

        document.querySelector(".form__log-in-button").addEventListener("click", function () {
          var login = elementsBase.getElement("logInLoginField").value;
          var password = elementsBase.getElement("logInPasswordField").value;

          var messageBox = elementsBase.getElement("logInMessageBox");
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  "use strict";
  /* harmony import */
  var __WEBPACK_IMPORTED_MODULE_0__sign_up_page_pug__ = __webpack_require__(13);
  ...
  var SignUpPage = function () {
    ...
    _createClass(SignUpPage, null, [{
      ...
      key: 'addEventsToElements',
      value: function addEventsToElements(router, elementsBase) {
        document.querySelector(".sign-up-page__link-to-log-in-page").addEventListener("click", function () {
          router.moveToPage("/log-in");
        });

        document.querySelector(".form__sign-up-button").addEventListener("click", function () {
          var login = elementsBase.getElement("signUpLoginField").value;
          var password = elementsBase.getElement("signUpPasswordField").value;

          var messageBox = elementsBase.getElement("signUpMessageBox");
          messageBox.innerHTML = "";
          ...
          if (messageArr.length === 0) {
            __WEBPACK_IMPORTED_MODULE_2__modules_AjaxWorker__["a" /* default */].sendPost("signup/", {
              ...
              if (message === "NO") {
                var _h = document.createElement('h3');
                _h.innerHTML = "Пользователь с таким логином уже есть в БД.";
                messageBox.appendChild(_h);
              }
            });
          }
        });
  ...
  __webpack_exports__["a"] = SignUpPage;
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  "use strict";
  /* harmony import */
  var __WEBPACK_IMPORTED_MODULE_0__main_menu_page_pug__ = __webpack_require__(17);
  ...
  __webpack_exports__["a"] = MainMenuPage;
  ...
  var Router = function () {
    ...
    _createClass(Router, [{
      ...
      value: function hidePages() {
        for (var i = 0; i < this.listOfPages.length; i++) {
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var ElementsBase = function () {
    function ElementsBase() {
      _classCallCheck(this, ElementsBase);

      this.elements = {};
    }

    _createClass(ElementsBase, [{
      key: 'addElement',
      value: function addElement(elementName, element) {
  ...
  __webpack_exports__["a"] = ElementsBase;
